    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('product_list', 'صفحه لیست محصولات'), ('product_detail', 'صفحه ی جزییات محصولات'), ('about_us', 'درباره ما'), ('articles_page', 'صفحه مقالات')], max_length=200, verbose_name='جایگاه نمایشی')),
            ],
            options={
